...
xref:man:3/getopt.adoc[*getopt*(3)] routine only allows options to
...
xref:man:3/libbu.adoc[*libbu*(3)] debug flags to the given hexadecimal
...
*-! #*:: turns on the xref:man:3/libbu.adoc[*libbu*(3)] library
...
xref:man:1/dbx.adoc[*dbx*(1)] or xref:man:1/gdb.adoc[*gdb*(1)] for
debugging. (Notice that [opt]*-x #* sets the
xref:man:3/libbt.adoc[*libbt*(3)] debug flags to the given hexadecimal
...
xref:man:1/tabinterp.adoc[*tabinterp*(1)],
xref:man:1/tabsub.adoc[*tabsub*(1)], and
xref:man:1/anim_script.adoc[*anim_script*(1)]. Also please consult the
...
xref:man:1/lgt.adoc[*lgt*(1)], xref:man:1/pix-fb.adoc[*pix-fb*(1)],
xref:man:1/png-fb.adoc[*png-fb*(1)],
xref:man:1/rtray.adoc[*rtray*(1)], xref:man:1/rtpp.adoc[*rtpp*(1)],
xref:man:3/librt.adoc[*librt*(3)], xref:man:5V/ray.adoc[*ray*(5V)],
