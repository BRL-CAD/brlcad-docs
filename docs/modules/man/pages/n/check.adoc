...
*[cmd]#check#*  [rep]_sub-command_ [[rep]_options_] [[rep]_objects_]...
...
*[opt]#-e#* _elevation_deg [deg|rad]_::
...
*[opt]#-G#* [__grid_width__,]__grid_height__::
...
*[opt]#-u#* _distance_units,volume_units,mass_units_::
