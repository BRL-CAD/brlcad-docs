...
used to specify file or directory names in xref:man:1/sh.adoc[*sh*(1)]
...
with xref:man:1/cat.adoc[*cat*(1)].
...
xref:man:1/cat.adoc[*cat*(1)],
xref:man:1V/gedplot.adoc[*gedplot*(1V)],
xref:man:1B/mged.adoc[*mged*(1B)]
