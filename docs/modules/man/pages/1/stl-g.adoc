...
*[cmd]#stl-g#* [-db][-i [rep]_initial_ident_][-I [rep]_constant_ident_][-m [rep]_material_code_][-N [rep]_forced_name_][-c [rep]_units_][-t [rep]_tolerance_][-x [rep]_RT_DEBUG_FLAG_][rep]_file.stl_[rep]_file.g_
